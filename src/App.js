...
import RetrievedTodos from './components/RetrievedTodos'
  ...
  render() {
    return (
      <div className="App container">
        ...
        <div className='retrieved-todos'>
          <RetrievedTodos todos={this.state.todos} markComplete={this.markComplete} deleteTodo={this.deleteTodo} />
        </div>
      </div>
    );
  }
